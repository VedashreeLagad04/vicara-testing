...
class Auth {
  ...
  void signInWithPhone(
      ...
      required void Function() cancelLoading,
    ...
    await _auth.verifyPhoneNumber(
      ...
      verificationFailed: (FirebaseAuthException authException) async {
        await FirebaseCrashlytics.instance.recordError(authException, authException.stackTrace,
            reason: "firebase signing in failed");
        Fluttertoast.showToast(
          msg:
