...
class _ContactSelectionScreenState extends State<ContactSelectionScreen> {
  ...
  @override
  void initState() {
    _contactService.getContacts(query: '').then((value) {
      allContacts = value;
      _isLoading = false;
      selecteds = widget.selectedContacts.map<Map<String, dynamic>>((element) => element).toList();
    });
    super.initState();
  }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              onChanged: (value) {
                _contactService.getContacts(query: value).then((value) {
                  setState(() {
                    allContacts = value;
                  });
                });
