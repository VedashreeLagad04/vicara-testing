  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: WillStartForegroundTask(
        androidNotificationOptions: AndroidNotificationOptions(channelId: 'vicara_fall_foreground', channelName: 'vicara_app'),
        notificationText: 'Foreground service is running',
        notificationTitle: 'Vicara foreground service',
