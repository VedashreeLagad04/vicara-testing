  ...
  Future<void> wsTalker(String? phone) async {
    ...
    if (channel == null) {
      ...
      StreamSubscription _majorStream =
        ...
        // _sensorFilteredData['gravityX'] = _sensorFilteredData['gravityX'].map((ele) {
        //   return LowPassFilter(1, _sensorFilteredData['gravityX'].length)
        //       .filter(_sensorFilteredData['gravityX']);
        // }).toList();
        // _sensorFilteredData['gravityY'] = _sensorFilteredData['gravityY'].map((ele) {
        //   return LowPassFilter(1, _sensorFilteredData['gravityY'].length)
        //       .filter(_sensorFilteredData['gravityY']);
        // }).toList();
        // _sensorFilteredData['gravityZ'] = _sensorFilteredData['gravityZ'].map((ele) {
        //   return LowPassFilter(1, _sensorFilteredData['gravityZ'].length)
        //       .filter(_sensorFilteredData['gravityZ']);
        // }).toList();
        // _sensorFilteredData['gyroX'] = _sensorFilteredData['gyroX'].map((ele) {
        //   return LowPassFilter(1, _sensorFilteredData['gyroX'].length)
        //       .filter(_sensorFilteredData['gyroX']);
        // }).toList();
        // _sensorFilteredData['gyroY'] = _sensorFilteredData['gyroY'].map((ele) {
        //   return LowPassFilter(1, _sensorFilteredData['gyroY'].length)
        //       .filter(_sensorFilteredData['gyroY']);
        // }).toList();
        // _sensorFilteredData['gyroZ'] = _sensorFilteredData['gyroZ'].map((ele) {
        //   return LowPassFilter(1, _sensorFilteredData['gyroZ'].length)
        //       .filter(_sensorFilteredData['gyroZ']);
        // }).toList();
        // _sensorFilteredData['linearAccelX'] = _sensorFilteredData['linearAccelX'].map((ele) {
        //   return LowPassFilter(1, _sensorFilteredData['linearAccelX'].length)
        //       .filter(_sensorFilteredData['linearAccelX']);
        // }).toList();
        // _sensorFilteredData['linearAccelY'] = _sensorFilteredData['linearAccelY'].map((ele) {
        //   return LowPassFilter(1, _sensorFilteredData['linearAccelY'].length)
        //       .filter(_sensorFilteredData['linearAccelY']);
        // }).toList();
        // _sensorFilteredData['linearAccelZ'] = _sensorFilteredData['linearAccelZ'].map((ele) {
        //   return LowPassFilter(1, _sensorFilteredData['linearAccelZ'].length)
        //       .filter(_sensorFilteredData['linearAccelZ']);
        // }).toList();
